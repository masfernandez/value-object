...
use Masfernandez\ValueObject\FloatNullableValueObject;
use PHPUnit\Framework\TestCase;
use Symfony\Component\Validator\Constraint;
use Symfony\Component\Validator\Constraints;
use TypeError;

class FloatNullableValueObjectTest extends TestCase
{
    public function testEmptyValue(): void
    {
        $this->expectException(TypeError::class);

        new class ('') extends FloatNullableValueObject {
        };
    }
    ...
    public function testNullValue(): void
    {
        ...
        $valueObject = new class ($valueExpected) extends FloatNullableValueObject {
        };
    ...
    public function testValueMethod(): void
    {
        ...
        $stringValueObject = new class ($valueExpected) extends FloatNullableValueObject {
        };
    ...
    {
        $stringValueObject = new class (123.00001) extends FloatNullableValueObject {
        };
    ...
    public function testToStringOnNullMethod(): void
    {
        ...
        $stringValueObject = new class (null) extends FloatNullableValueObject {
        };

        $this->assertEquals(null, $stringValueObject->__toString());
    }
    ...
    public function testLengthValueCustomConstraints(): void
    {
        ...
        new class (1234567891011) extends FloatNullableValueObject {
            /** @return Constraint[] */
